...
class Habit extends Model
{
    ...
    {
        return $this->hasMany(\App\Models\Habits\HabitSchedule::class);
    }
    ...
    {
        return $this->hasMany(\App\Models\Habits\HabitParticipant::class);
    }
    ...
    {
        return $this->hasMany(\App\Models\Habits\HabitParticipant::class)->where('status', 'approved');
    }
    ...
    {
        return $this->hasMany(\App\Models\Habits\HabitLog::class);
    }
    ...
    {
        return $this->hasMany(\App\Models\Habits\HabitInvitation::class);
    }
