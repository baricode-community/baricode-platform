...
new class extends Component {
    ...
    public function openCreateModal()
    {
        ...
        $maxOrder = CourseModule::where('course_id', $this->courseId)->max('order');
    ...
    public function save()
    {
        ...
        $existingModule = CourseModule::where('course_id', $this->courseId)
...
<div>
    <div class="flex justify-between items-center mb-6">
        <h3 class="text-xl font-semibold text-gray-900">Daftar Modul</h3>
        <button 
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center gap-4 mt-2 text-sm text-gray-500">
                                            <span>{{ $module->course_module_lessons_count }} pelajaran</span>
                                            <span>Dibuat: {{ $module->created_at->format('d M Y') }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="sm:flex sm:items-start">
                                <div class="w-full">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            <label for="name" class="block text-sm font-medium text-gray-700">Nama Modul</label>
                                            <input 
                                                wire:model="name"
                                                type="text" 
                                                id="name"
