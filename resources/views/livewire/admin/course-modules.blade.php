...
new #[Layout('layouts.app')] class extends Component {
    ...
    public function mount($courseId)
    {
        ...
        $this->course = Course::with('courseCategory')->findOrFail($courseId);
    }
}; ?>
            ...
            <div class="p-6 text-gray-900">
                ...
                <div class="mb-8">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-3xl font-bold text-gray-900 mb-2">Modul untuk "{{ $course->title }}"</h1>
                            <p class="text-gray-600">
                                Kelola semua modul untuk kursus ini
                ...
                <!-- Module management component with course filter -->
                <livewire:admin.course-module-management :courseId="$courseId" />
            </div>
        </div>
    </div>
</div>
