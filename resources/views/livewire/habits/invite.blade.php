...
new #[Layout('components.layouts.app')] class extends Component
{
    ...
    {
        return 'Undang Teman - ' . $this->habit->name;
    }
}; ?>
    ...
    <div class="">
        ...
        <div class="mb-8">
            <div class="flex items-center mb-4">
                ...
                <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Undang Teman ke {{ $habit->name }}</h1>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    @else
                        <div class="space-y-3 max-h-96 overflow-y-auto pr-2">
                            @foreach($users as $user)
                                {{-- User Card/Label --}}
                                <label class="flex items-center p-3 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition duration-150 {{ in_array($user['id'], $selectedUsers) ? 'ring-2 ring-blue-500 bg-blue-50 dark:bg-blue-900/20' : '' }}">
                                    <input type="checkbox" 
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <div>
                        ...
                        <textarea wire:model="message"
                                  ...
                                  placeholder="Tulis pesan untuk mengajak teman bergabung dalam habit ini..."></textarea>
                ...
                @if(!empty($users) && count($selectedUsers) > 0)
                    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                        <button wire:click="sendInvitations"
                            ...
                            <span wire:loading.remove>Kirim Undangan ({{ count($selectedUsers) }})</span>
