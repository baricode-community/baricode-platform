...
<li class="group relative border-b pb-6 bg-white hover:bg-blue-50 transition-colors duration-200 rounded-xl px-6 py-5 shadow-md flex flex-col sm:flex-row sm:items-center sm:justify-between">
    <div class="flex items-center space-x-5">
        <div class="bg-gradient-to-tr from-blue-200 to-blue-400 text-blue-800 rounded-full p-3 shadow group-hover:scale-105 transition-transform duration-200 hidden sm:block">
