<div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-5 mb-6">
        ...
        <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
            <p class="text-sm text-gray-600 dark:text-gray-400">
                ...
                proyek ditemukan
                @if($search)
                    <span class="ml-1">yang cocok dengan "<span class="font-medium text-blue-600 dark:text-blue-400">{{ $search }}</span>"</span>
                @endif
            </p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        @forelse($projects as $project)
            <a href="{{ route('time-tracker.show', $project->id) }}" 
        ...
        @empty
            <div class="col-span-full bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded-xl shadow-md p-12 text-center">
                <div class="max-w-sm mx-auto">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mb-4">Mulai mengorganisir pekerjaan Anda dengan membuat proyek pertama.</p>
                    <button wire:click="openCreateModal" 
