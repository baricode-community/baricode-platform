...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div class="p-8">
            <!-- Header -->
            <div class="mb-6">
                <h1 class="text-3xl font-bold text-gray-900 mb-4">{{ $meet->title }}</h1>
                ...
                @auth
                    @if ($meet->isParticipant(auth()->user()))
                        ...
                        <button wire:click="leaveMeet" 
                                class="inline-flex items-center justify-center px-6 py-3 border border-red-300 text-base font-medium rounded-md text-red-700 bg-red-50 hover:bg-red-100 transition-colors">
            ...
            @if ($meet->users->count() > 0)
                <div>
                    <h2 class="text-lg font-semibold text-gray-900 mb-4">Daftar Peserta</h2>
                    <div class="bg-gray-50 rounded-lg p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                            @foreach ($meet->users as $participant)
                                <div class="flex items-center space-x-3 p-3 bg-white rounded-md">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-xs text-gray-500">
                                            Bergabung {{ $participant->pivot->joined_at ? $participant->pivot->joined_at->diffForHumans() : '' }}
                                        </p>
                                    </div>
                                </div>
                            @endforeach
            ...
            @else
                <div class="text-center py-8">
                    ...
                    <h3 class="mt-4 text-sm font-medium text-gray-900">Belum ada peserta</h3>
                    <p class="mt-2 text-sm text-gray-500">Jadilah yang pertama bergabung dengan meet ini!</p>
                </div>
            @endif
        </div>
    </div>
