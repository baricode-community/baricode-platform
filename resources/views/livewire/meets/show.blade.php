...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    @if (session()->has('success'))
        <div class="bg-green-50 border border-green-200 text-green-600 dark:bg-green-900 dark:border-green-700 dark:text-green-200 px-4 py-3 rounded-md mb-6">
            {{ session('success') }}
        </div>
    @endif

    @if (session()->has('error'))
        <div class="bg-red-50 border border-red-200 text-red-600 dark:bg-red-900 dark:border-red-700 dark:text-red-200 px-4 py-3 rounded-md mb-6">
            {{ session('error') }}
        </div>
    @endif

    <!-- Meet Details -->
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 dark:bg-gray-900 dark:border-gray-700 overflow-hidden">
        <div class="p-8">
            <!-- Header -->
            <div class="mb-6">
                                ...
                                <div class="flex items-center space-x-3 p-3 bg-white dark:bg-gray-900 rounded-md">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400">
                                            Bergabung {{ $participant->pivot->joined_at ? $participant->pivot->joined_at : '' }}
                                        </p>
                                    </div>
                                </div>
                            @endforeach
            ...
            @else
                <div class="text-center py-8">
                    ...
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Jadilah yang pertama bergabung dengan meet ini!</p>
                </div>
            @endif
        </div>
    </div>
