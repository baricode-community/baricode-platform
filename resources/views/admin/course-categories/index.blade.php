<x-layouts.app :title="__('Dashboard')">
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Kelola Kategori Kursus</h1>
                <p class="text-gray-600 mt-1">Kelola kategori untuk mengorganisir kursus-kursus Anda</p>
            </div>
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-900">Daftar Kategori Kursus</h2>
            </div>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-2">
                                            ...
                                            <!-- View -->
                                            <a href="{{ route('admin.course-categories.show', $category) }}"
            ...
            @else
                <div class="px-6 py-12 text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Mulai dengan membuat kategori kursus pertama Anda.</p>
                    <div class="mt-6">
                        <a href="{{ route('admin.course-categories.create') }}"
