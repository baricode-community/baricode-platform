...
@section('title', 'Lanjut - Baricode Community')

@section('content')
    <section class="py-20 md:py-32 px-4 bg-gray-900 text-white min-h-screen">
        <div class="max-w-7xl mx-auto">
            <h1 class="text-4xl md:text-5xl font-bold text-center mb-8">Kursus untuk Lanjut</h1>
            <p class="text-lg md:text-xl text-gray-400 text-center mb-16">
                Kuasai keahlian tingkat lanjut dengan kursus-kursus expert yang akan membuatmu menjadi profesional.
            </p>
        </div>
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            @empty
                <div class="col-span-full text-center text-gray-500">
                    Belum ada kategori untuk lanjut.
                </div>
            @endforelse
        </div>
    </section>
