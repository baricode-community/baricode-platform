...
@section('content')
    <style>
        / CSS untuk Animasi / @keyframes fadeIn {
            from {
                opacity: 0;
            }
        ...
        / Animasi Baru & Variasi / .animate-fade-in-up-4 {
    ...
    <div class="overflow-hidden">
        ...
        <section
            ...
            <div class="max-w-5xl mx-auto relative z-10">
                <h1
                    class="text-2xl sm:text-3xl md:text-5xl font-extrabold leading-snug mb-6 animate-fade-in-up drop-shadow-lg">
                    <span class="text-indigo-300">Belajar Ngoding Gratis 100%.</span> <br class="hidden md:inline-block">
                    Bangun
                    Proyek Bareng.
                </h1>
                <p
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div
                        ...
                        <p class="text-gray-300">Belajar dari nol hingga mahir dengan kurikulum yang kami rancang bersama.
                            Jalur
                            jelas.</p>
                    </div>
                    <div
                        ...
                        <p class="text-gray-300">Berinteraksi, saling bantu, dan bangun koneksi kuat dengan sesama
                            developer.
                        </p>
                    </div>
                    <div
                        ...
                        <p class="text-gray-300">Terapkan ilmu yang kamu dapat dengan membangun proyek nyata bersama.
                            Portofolio
                            instan!</p>
                    </div>
                    <div
                ...
                <div class="space-y-6">
                    <details class="bg-gray-800 p-6 rounded-xl shadow-lg cursor-pointer group">
                        ...
                        <p class="text-gray-300 mt-4 border-l-4 border-indigo-500 pl-4">Ya, 100% gratis. Semua materi
                            pembelajaran dan akses ke komunitas sepenuhnya gratis, tanpa biaya tersembunyi. Kami percaya
                            pada
                    ...
                    <details class="bg-gray-800 p-6 rounded-xl shadow-lg cursor-pointer group">
                        ...
                        <p class="text-gray-300 mt-4 border-l-4 border-indigo-500 pl-4">Anda cukup menekan tombol "Daftar
                            Sekarang" di bawah atau di bagian atas, dan ikuti langkah-langkah registrasi yang mudah. Anda
                            akan
                    ...
                    <details class="bg-gray-800 p-6 rounded-xl shadow-lg cursor-pointer group">
                        ...
                        <p class="text-gray-300 mt-4 border-l-4 border-indigo-500 pl-4">Hanya niat untuk belajar! Kami
                            menyambut siapa saja, dari pemula yang belum pernah ngoding sampai mereka yang sudah
                            berpengalaman.
        ...
        <section class="py-20 px-4 bg-gray-900">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="relative flex flex-col md:flex-row justify-between items-start gap-12">
                    ...
                    {{-- Garis penghubung --}}
                    <div class="hidden md:block absolute top-10 left-0 right-0 h-1 bg-gray-700 z-0 animate-scale-in-2">
                    </div>
        ...
        <section class="py-20 px-4 bg-gray-900">
            <div class="max-w-7xl mx-auto text-center">
                ...
                <p class="text-gray-300 text-lg mb-8 max-w-4xl mx-auto animate-fade-in-up-2">
                    Kami membangun platform ini bersama. Semua materi, kode sumber, dan kurikulum kami adalah open-source.
                    Ini
        ...
        <section class="py-20 px-4 bg-gray-900 border-t border-gray-700">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <blockquote
                    class="text-2xl italic text-gray-300 border-l-4 border-yellow-500 pl-4 mx-auto animate-fade-in-up-2">
                    "Setiap bug yang berhasil kamu pecahkan bukan hanya mengasah skill-mu, tapi juga menambah satu cerita
                    heroik
