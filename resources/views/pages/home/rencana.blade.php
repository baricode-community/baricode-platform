...
@section('title', 'Rencana Baricode - Komunitas Belajar Ngoding')
    ...
    <section class="py-24 px-4 bg-gradient-to-br from-indigo-800 via-purple-800 to-pink-800 relative overflow-hidden">
        ...
        <div class="max-w-5xl mx-auto relative z-10">
            <h2 class="text-4xl md:text-5xl font-extrabold text-center mb-10 text-white drop-shadow-lg animate-fade-in-up">
                Rencana <span
                    class="bg-gradient-to-r from-pink-400 via-purple-400 to-indigo-400 bg-clip-text text-transparent">Baricode</span>
            </h2>
            <div class="flex flex-col md:flex-row items-center justify-center gap-12">
                <div
                    ...
                    <iframe src="https://app.xmind.com/embed/FLALuwuV?sheet-id=eb4cf597-997b-4f04-8a89-0ea4cd690a4e"
