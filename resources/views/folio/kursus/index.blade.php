...
$categories = \App\Models\Category::with(['courses' => function($q) { $q->where('is_published', true); }])->get();
?>
                                ...
                                <div class="bg-gray-800 rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition duration-300 ease-in-out">
                                    ...
                                    <div class="p-6">
                                        ...
                                        <a href="{{ route('course', ['course' => $course]) }}"
                                            class="inline-block bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-md transition duration-300">Lihat Kursus</a>
                                    </div>
                                </div>
                            @endforeach
                        </div>
